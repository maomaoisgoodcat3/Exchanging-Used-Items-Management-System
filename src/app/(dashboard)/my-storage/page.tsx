...
export default function MyStoragePage() {
  ...
  useEffect(() => {
    const filteredByMe = mockPosts.filter(post => post.sellerName === "Nguyễn A");
    setMyPosts(filteredByMe);
  }, []);
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="flex w-full md:w-auto gap-3 flex-grow justify-end">
          ...
          {/* Thanh tìm kiếm */}
          <input
            className="border rounded-lg px-4 py-2 w-full md:w-64 bg-gray-50 focus:bg-white transition-colors outline-none focus:ring-2 focus:ring-blue-200"
          ...
          return (
            <div key={post.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 hover:shadow-md hover:border-blue-200 transition-all group">
              ...
              <div className="flex-1 space-y-2 w-full">
                ...
                <div className={`font-black text-lg pt-1 ${isFree ? "text-green-600" : "text-red-600"}`}>
